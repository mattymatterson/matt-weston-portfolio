...
<div class="nav-side-menu" id="left-nav">
    <div class="brand" id="Profile"><?php echo $_SESSION['user_id']?><span class="glyphicon glyphicon-menu-down"></span><span id="collapse-left-navbar" class="glyphicon glyphicon-menu-left"></span></div>
